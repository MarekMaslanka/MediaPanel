...
#define DREQ_PIN	VS1003_DREQ_Pin
#define DREQ_PORT	VS1003_DREQ_GPIO_Port
#define CS_PORT		VS1003_XCS_GPIO_Port
#define CS_PIN		VS1003_XCS_Pin
#define XDCS_PORT   VS1003_XDCS_GPIO_Port
#define XDCS_PIN	VS1003_XDCS_Pin
#define XRESET_PORT	VS1003_XRES_GPIO_Port
#define XRESET_PIN	VS1003_XRES_Pin
